...
namespace CustomerManagement
{
...

        {
            ...
            public Management()
            {
                ...
                {
                    new Customer { Id = 1234, FirstName="John", LastName="Wick", Email="johnwick@gmail.com", Age =32, Phone = "9898989898", City = "UK"},
                    new Customer { Id = 4321, FirstName="Sisu", LastName="Rota", Email="sisurota@gmail.com", Age =23, Phone = "9678878877", City = "UAE"},
                };
            }
